...
import {Keyboard,Image, Dimensions , Text, View,StyleSheet,ScrollView, TextInput,FlatList, TouchableWithoutFeedback, Alert, KeyboardAvoidingView} from 'react-native';
...
class Terms extends React.Component {
  ...
  render() {
    return (
     ...
     <Text style={styles.Text}>These terms and conditions ("Terms", "Agreement") are an agreement between Mobile Application Developer ("Mobile Application Developer", "us", "we" or "our") and you ("User", "you" or "your"). This Agreement sets forth the general terms and conditions of your use of the Hostel Wiz mobile application and any of its products or services (collectively, "Mobile Application" or "Services"). </Text>
     ...
     <Text style={styles.titleText}>User content</Text>
     ...
     <Text style={styles.titleText}>Backups</Text>
     <Text style={styles.Text}>We perform regular backups of the Content and will do our best to ensure completeness and accuracy of these backups. In the event of the hardware failure or data loss we will restore backups automatically to minimize the impact and downtime. </Text>
     <Text style={styles.titleText}>Links to other mobile applications</Text>
     ...
     <Text style={styles.Text}>If you have any questions about this Agreement, please contact us.
   This document was last updated on June 11, 2020</Text>
